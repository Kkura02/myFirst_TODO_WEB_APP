...
const addTodos = () => {
    ...
    // let card = "<div class='border-2 border-black shadow-md p-4 flex flex-col justify-around items-start'><b class='text-xl font-bold'>Todo Title</b><p class='text-base'>Todo Description Loren Ipsum</p></div>" ; //put here the format div
    // li.textContent = card;

    // let title = todoTitle.value;
    // let desc = todoDesc.value;
    // document.getElementById("yesTodos").innerHTML += "<li><div class='border-2 border-black shadow-md p-4 flex flex-col justify-around items-start'><b class='text-xl font-bold'>"+title+"</b><p class='text-base'>"+desc+"</p></div></li>";
...
function saveTODO(){
    ...
    // document.querySelector(".todos").innerHTML += "<li><div class='border-2 border-black shadow-md p-4 flex flex-col justify-around items-start'><b class='text-xl font-bold'>Todo Title</b><p class='text-base'>Todo Description Loren Ipsum</p></div></li>";
    ...
    //if the todos array is not empty show the div that shows the TODO List"
       ...
       //Loop that calls all data into the card
        for (var i = 0; i < listtodo.length; i++){
            // console.log(listtodo[i][0])
            // console.log(localStorage.getItem(localStorage.key(i).todoTitle.value));
